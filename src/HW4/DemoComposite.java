...
public class DemoComposite {
    ...
    public static void main(String[] args) {
        ...
        sabinaPlaylist.add(new SongMP4(new Song("Princesa", "Joaquín Sabina")));
        ...
        garciaPlaylist.add(new SongViniyl(new Song("A San Fernando, un ratito a pie y otro caminando", "Manolo García")));
        ...
        mySongs.add(new SongViniyl(new Song("Penso positivo", "Lorenzo Jovanotti")));
